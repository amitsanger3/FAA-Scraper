...
class FaaDatabase(object):
    ...
    def __init__(self, logger=gdelt_data_logger):
        ...
        self.logger = logger
        self.gdelt_url_table = "faaUrls"
        try:
            self.create_gdelt_url_table()
        except:
            print(traceback.print_exc(), "--------------0000000000000000000")
    ...
    def db_connection(self):
        ...
        try:
            ...
            print(traceback.print_exc(), "DB CONNECTION ERROR")
    ...
    def gdelt_url_insert(self,  url):
        ...
        try:
            ...
            print(traceback.print_exc(), "DB INSERT ERROR")
